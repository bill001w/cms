...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<a href="<?php if ($backurl) {  echo $backurl;  } else {  echo url('admin/content', array('catid'=>$catid, 'modelid'=>$modelid));  } ?>" onclick="clz()"><em><?php echo lang('a-con-42'); ?></em></a><span>|</span>
	...
	<div class="table-responsive mytable">
		...
		<tr>
			<th><font color="red">*</font>&nbsp;<?php echo lang('a-con-26'); ?>：</th>
