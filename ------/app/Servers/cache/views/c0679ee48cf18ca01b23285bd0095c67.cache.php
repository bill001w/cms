...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		...
		<a href="<?php echo url('admin/content/verify', array('catid'=>$catid,'modelid'=>$modelid,'status'=>3)); ?>" <?php if ($status==3) { ?>class="on"<?php } ?>><em><?php echo lang('a-con-21'); ?>(<?php echo $count[1]; ?>)</em></a><span>|</span>
		<a href="<?php echo url('admin/content/verify', array('catid'=>$catid,'modelid'=>$modelid,'status'=>2)); ?>" <?php if ($status==2) { ?>class="on"<?php } ?>><em><?php echo lang('a-con-22'); ?>(<?php echo $count[2]; ?>)</em></a><span>|</span>
		<a href="<?php echo url('admin/content/index', array('catid'=>$catid,'modelid'=>$modelid,'recycle'=>1)); ?>" <?php if ($recycle==1) { ?>class="on"<?php } ?>><em><?php echo lang('a-con-23'); ?>(<?php echo $count[0]; ?>)</em></a><span>|</span>
