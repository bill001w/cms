<?php  namespace App\Servers\dayrui\libraries;  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
/**
 * CodeIgniter
 *
...
class CI_Profiler {
	...
	public function run()
	{
		$output = "<div id='codeigniter_profiler' style='clear:both;background-color:#f1f2f7;padding:10px;'>";
		$fields_displayed = 0;
