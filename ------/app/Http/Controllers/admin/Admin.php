...
use App\Servers\libraries\auth;
use App\Servers\drivers\App;
use App\Servers\models\userModel;
...
class Admin extends Common
{
    ...
    protected function isAdminLogin($request)
    {
        ...
        if (substr($route_name, 0, 5) !== 'admin' || $route_name === 'admin/login/index') {
            return false;
        }
        ...
        $this->redirect(url('admin/login?url=' . urlencode($request->url())));
    }
