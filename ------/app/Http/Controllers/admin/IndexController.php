...
use App\Servers\dayrui\libraries\file_list;
...
class IndexController extends Admin
{
    ...
    public function bqAction(Request $request)
    {
...
return array(
    ...
    public function logAction(Request $request)
    {
        ...
        $pagelist = $pagelist->total($total)->url(url('/index/log', array('page' => '{page}', 'username' => $username)))->num($pagesize)->page($page)->output();
        $this->view->assign(array(
            'list' => $list,
            'pagelist' => $pagelist
        ));
    ...
    public function clearlogAction()
    {
        ...
        $this->adminMsg(lang('a-ind-32') . '(#' . $count . ')', url('admin/index/log'), 3, 1, 1);
    }
    ...
    public function clearattackAction()
    {
        ...
        $this->adminMsg(lang('a-ind-32') . '(#' . $count . ')', url('admin/index/attack'), 3, 1, 1);
    }
    ...
    public function updatecacheAction()
    {
        ...
        $c = $this->get('cc');
        ControllerTool::redirect(url('admin/' . $c . '/' . $a) . '&cache=1');
    }
