...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		...
		<a href="<?php echo url('admin/theme/demo')?>"><em><?php echo lang('标签向导'); ?></em></a><span>|</span>
	...
	<div class="table-responsive mytable">
		...
		<tr>
			...
			&nbsp;<a href="javascript:;" onClick="if(confirm('<?php echo lang('a-confirm'); ?>')){ window.location.href='<?php echo url('admin/theme/del',array('name'=>$t['dir'])); ?>'; }" title="<?php echo lang('a-del'); ?>">×</a><?php }  if (!$istop && $t['tdir'] != 'mobile') { ?>
				&nbsp;
				<?php if ($SITE_THEME == $t['tdir']) { ?>
				<span class="label label-important"><?php echo lang('a-now-install'); ?></span>
				<?php } else { ?>
				<a href="javascript:;" onClick="if(confirm('<?php echo lang('a-confirm-install'); ?>')){ window.location.href='<?php echo url('admin/theme/install',array('name'=>$t['tdir'])); ?>'; }" class="label label-success" title="<?php echo lang('a-install'); ?>"><?php echo lang('a-install'); ?></a>
				<?php }  } ?>
			</td>
		</tr>
