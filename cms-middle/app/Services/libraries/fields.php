...
function form_linkage($setting = '') {
    $link = ControllerTool::model('linkage');
...
function ueditor_editor($name, $content = '', $field = '') {
	...
	if (!defined('FINECMS_EDITOR_LD')) { //加载相关js
	    $str.= '
		<script type="text/javascript">var ueditor_url="/extensions/ueditor/";</script>
...
function content_date($name, $content = '', $field = '') {
	...
	if (!defined('FINECMS_DATE_LD')) {
	    $str .= '
		<link href="/extensions/calendar/jscal2.css" type="text/css" rel="stylesheet">
		<link href="/extensions/calendar/border-radius.css" type="text/css" rel="stylesheet">
		<link href="/extensions/calendar/win2k.css" type="text/css" rel="stylesheet">
		<script type="text/javascript" src="/extensions/calendar/calendar.js"></script>
		<script type="text/javascript" src="/extensions/language/zh-cn/calendar.js"></script>
		<script type="text/javascript" src="/views/admin/js/jquery-ui.min.js"></script>';
