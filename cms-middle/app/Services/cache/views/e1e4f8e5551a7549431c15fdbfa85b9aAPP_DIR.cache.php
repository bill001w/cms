...
<div class="subnav">
	...
	<div class="table-responsive mytable">
		...
		<?php if ($istop) { ?>
		<tr>
		    <td align="left"><a href="<?php echo $pdir; ?>"><img src="/views/admin/images/folder-closed.gif"><?php echo lang('a-att-5'); ?></a></td><td></td>
		</tr>
		...
		<tr>
			...
			<img src="/views/admin/images/ext/<?php echo $t['ico']; ?>">&nbsp;<a href="<?php if ($t['url']) {  echo $t['url'];  } else {  if ($t['isimg']) { ?>javascript:preview('thumb_<?php echo $k; ?>');<?php } else { ?>javascript:fileview_<?php echo $k; ?>();<?php }  } ?>" <?php if ($t['isimg']) { ?>rel="<?php echo $dir;  echo $t['name']; ?>" title="<?php echo $t['name']; ?>"<?php } ?>><?php echo $t['name']; ?></a></td>
			<td width="30%">
