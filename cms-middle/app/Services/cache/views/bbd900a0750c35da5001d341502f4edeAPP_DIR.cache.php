...
<script type="text/javascript">
    ...
    function del(id) {
        if (confirm('<?php echo lang('a-cat-11'); ?>')) {
            $('#load').show();
            var url = "<?php echo url('admin/category/del'); ?>"+ '/' + id;
...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		...
		<?php if (admin_auth($userinfo['roleid'], 'category-add')) { ?><a href="<?php echo url('admin/category/add'); ?>"><em><?php echo lang('a-cat-13'); ?></em></a><span>|</span><?php }  if (admin_auth($userinfo['roleid'], 'category-cache')) { ?><a href="<?php echo url('admin/category/cache'); ?>"><em><?php echo lang('a-cache'); ?></em></a><?php } ?>
	</div>
	<div class="bk10"></div>
	<div class="table-responsive mytable">
		...
		<tr>
			...
			<td align="center">&nbsp;<?php if (isset($c['url']['tohtml'])) { ?><span class="label label-success">√</span><?php } else { ?><span class="label label-important">×</span><?php } ?></td>
