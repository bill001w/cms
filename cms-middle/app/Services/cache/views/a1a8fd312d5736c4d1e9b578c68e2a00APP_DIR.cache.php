                ...
                <li>
                    ...
                    <ul style="padding-left:40px;" class="nav nav-second-level">
                        <script type="text/javascript">
                            ...
                            d.add(<?php echo intval($t[catid]); ?>, <?php echo intval($t[parentid]); ?>, '<?php echo str_replace(array("'", '"'), "", $t[catname]); ?>', '<?php if ($t[child]) {  if ($t[typeid]==2) {  echo url('admin/content/index', array('catid'=>$t[catid],'modelid'=>$t[modelid]));  }  } else {  echo url('admin/content/index', array('catid'=>$t[catid]));  } ?>', '', 'right');
                            <?php }  } } ?>
                            document.write(d);
                        </script>
                    </ul>
