...
<script type="text/javascript" src="/views/admin/js/dialog.js"></script><?php include $this->_include('admin/top.html'); ?>
<title>admin</title>
</head>
...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		...
		<a href="<?php echo url('admin/member/group/add'); ?>"><em><?php echo lang('a-add'); ?></em></a><span>|</span>
	...
	<div class="bk10"></div><div class="table-responsive mytable">
		...
		<tr height="25">
			...
			<a href="<?php echo url('admin/member/group/edit') . '?id=' . $t['id']; ?>"><?php echo lang('a-edit'); ?></a> |
		...
		<tr height="25">
			...
			<input type="submit" class="btn btn-success btn-sm" value="<?php echo lang('a-del'); ?>" name="submit_del" onClick="$('#list_form').val('del');return confirm_del()" />&nbsp;
			<input type="submit" class="btn btn-success btn-sm" value="<?php echo lang('a-order'); ?>" name="submit_order" onClick="$('#list_form').val('order')" />&nbsp;
			</td>
		</tr>
		</table>
		<?php echo $pagelist; ?>
