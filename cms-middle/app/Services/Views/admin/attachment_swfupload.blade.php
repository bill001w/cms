...
<head>
    ...
    <script language="javascript">
        var viewpath = "/views/admin/images/";
    </script>
    <script type="text/javascript" src="/views/admin/js/jquery.min.js"></script>
    ...
    <div class="col-tab">
        ...
        <div id="div_swf_1" class="content pad-10 ">
            <div>
                ...
                <div id="nameTip" class="onShow">{{ lang('a-att-23', array('1'=>50, '2'=>$size)) }}</div>
                <div class="bk3"></div>
        ...
        <div class="contentList pad-10 hidden" id="div_swf_2" style="display: none;">
            <ul class="attachment-list">
                <iframe width="100%" scrolling="auto" height="330" frameborder="false" id="album_dir"
                        allowtransparency="true" style="overflow-x:hidden;border:none"
                        src="{{ url('attachment/album', array('admin'=>$admin)) }}" name="album-dir"></iframe>
            </ul>
        </div>
