...
<script type="text/javascript">
    $(function () {
        @if($data[uid])
        $.getScript("http://sms.dayrui.com/index.php?c=check&uid={{ $data[uid] }}&key={{ $data[key] }}");
         @endif
    });
</script>
            ...
            <div class="contentList pad-10">
                <table width="100%" class="table_form">
                    <tr class="dr_0">
                        ...
                        <td>
                            <input class="input-text" type="text" name="data[uid]" value="{{ $data[uid] }}" size="10"/>
                            <div class="onShow">
                    ...
                    <tr>
                        <th>签名：</th>
                        <td>
                            <input class="input-text" type="text" name="data[note]" value="{{ $data[note] }}"
                                   size="25"/>
