...
<form action="" method="post" name="myform" id="myform">
    <div class="subnav">
        <div class="content-menu ib-a blue line-x">
            <a href="{{ url('admin/sms/index') }}"><em>{{ lang('dr005')}}</em></a><span>|</span>
            <a href="{{ url('admin/sms/send') }}" class="on"><em>{{ lang('dr006')}}</em></a><span>|</span>
            ...
            <div class="contentList pad-10">
                <table width="100%" class="table_form">
                    <tr>
                        <th width="200">类型：</th>
                        <td>
                            <input name="is_all" type="radio" value="0" onclick="$('.dr_0').show();$('.dr_1').hide();"
                                   checked="checked"/>&nbsp;单发&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr class="dr_1" style="display:none">
                        <th>手机号码：</th>
                        <td>
                            <textarea class="input-text" name="data[mobiles]"
                                      style="height:200px; width:150px;"></textarea>
                    ...
                    <tr>
                        <th>短信内容：</th>
                        <td>
                            <textarea class="input-text" name="data[content]"
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="btn btn-success btn-sm" type="button" name="button" value="发送"
                                   onclick="dr_send()"/>
                            &nbsp;&nbsp;
...
<script type="text/javascript">
    function dr_send() {
        ...
        $.ajax({
            type: "POST", dataType: "json", url: "{{ url('admin/sms/ajaxsend') }}&" + Math.random(), data: data,
