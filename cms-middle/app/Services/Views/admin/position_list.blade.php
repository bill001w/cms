...
<div class="subnav">
    <div class="content-menu ib-a blue line-x">
        ...
        @if(admin_auth($userinfo['roleid'], 'position-add'))
            <a href="{{ url('admin/position/add/') }}"><em>{{ lang('a-add')}}</em></a><span>|</span> @endif
            ...
            <table width="100%" class="table table-striped">
                ...
                <tr>
                    <td colspan="7" align="left">&nbsp;
                        <input @if(!admin_auth($userinfo['roleid'], 'position-del'))
                               disabled @endif
